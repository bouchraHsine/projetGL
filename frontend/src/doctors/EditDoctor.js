// frontend/src/doctors/EditDoctor.js
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <h2 className="text-xl font-semibold text-gray-800 mb-6 flex items-center gap-2">
              ...
              Congés et absences programmées
            </h2>

            <div className="space-y-4">
              {form.absences.map((absence, index) => (
                <div key={index} className="grid grid-cols-1 md:grid-cols-12 gap-3 items-start p-4 border border-gray-200 rounded-xl hover:border-indigo-300 transition-colors">
                  ...
                  <div className="md:col-span-5">
                    ...
                    <input 
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                      placeholder="Congés annuels, formation..."
                    />
                  </div>
              ...
              <button 
                type="button"
                onClick={addAbsence}
                className="flex items-center gap-2 px-4 py-3 border-2 border-dashed border-gray-300 text-gray-600 hover:border-indigo-400 hover:text-indigo-600 rounded-xl transition-all w-full justify-center"
              >
          ...
          <div className="flex justify-end gap-4 pt-6">
            ...
            <button 
              type="submit"
              disabled={saving}
              className="flex items-center gap-2 px-8 py-3 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium"
            >
